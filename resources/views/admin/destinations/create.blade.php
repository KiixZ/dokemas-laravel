...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Create New Destination</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.destinations.store') }}" enctype="multipart/form-data" id="destinationForm">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">Maximum file size: 2MB per image. Supported formats: JPEG, PNG, GIF</div>
                            @error('gallery.*')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
