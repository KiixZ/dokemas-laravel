...
@section('title', 'Create New Destination - Admin Dashboard')
            ...
            <div class="card-body">
                <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('location') is-invalid @enderror" id="location" name="location" rows="2">{{ old('location') }}</textarea>
                        @error('location')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    mainImageInput.addEventListener('change', function() {
        if (this.files && this.files[0]) {
            ...
            reader.onload = function(e) {
                // You could add an img element to preview the main image
            };
    ...
    galleryInput.addEventListener('change', function() {
        // You could add preview functionality for gallery images here
    });
});
</script>
@endsection
